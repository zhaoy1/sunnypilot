...
from openpilot.selfdrive.ui.onroad.cruise_button import CruiseButton
...
class HudRenderer(Widget):
  def __init__(self):
    ...
    self._cruise_button = CruiseButton()
  ...
  def _render(self, rect: rl.Rectangle) -> None:
    ...
    # Position experimental mode button on the right
  ...
  def handle_mouse_event(self) -> bool:
    ...
    if self._cruise_button.handle_mouse_event():
      return True
  ...
  def _draw_current_speed(self, rect: rl.Rectangle) -> None:
    ...
    # Draw + and - buttons next to the speed
    button_y = 180
    plus_x = rect.x + 100
    minus_x = rect.x + rect.width - 300

    rl.draw_text_ex(self._font_bold, "+", rl.Vector2(plus_x, button_y), 120, 0, COLORS.white)
    rl.draw_text_ex(self._font_bold, "-", rl.Vector2(minus_x, button_y), 120, 0, COLORS.white)
