...
class Car:
  ...
  def __init__(self, CI=None, RI=None) -> None:
    ...
    self.sm = messaging.SubMaster(['pandaStates', 'carControl', 'onroadEvents'] + ['carControlSP', 'longitudinalPlanSP', 'liveMapDataSP'])
  ...
  def read_cruise_speed_mode(self):
    """Read cruise speed mode from parameter"""
    try:
      return self.params.get_int("CruiseSpeedMode")
